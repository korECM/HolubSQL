 ...
 */
    ...
    private List<OrderFactory.Order> orderList() throws ParseFailure {
        ...
        if (in.matchAdvance(ORDER) != null) {
            ...
            String id;
            while ((id = in.matchAdvance(IDENTIFIER)) != null) {
                orderColumns.add(new OrderFactory.Order(id, isAsc()));
    ...
    private Boolean aggregateColumnToNormalColumn(List<String> columns, List<String> aggregateColumnList) throws ParseFailure {
        ...
        if (ejectedColumnList.size() > 0) {
            aggregateColumnList.addAll(columns);
            columns.clear();
            columns.addAll(ejectedColumnList);
        }
