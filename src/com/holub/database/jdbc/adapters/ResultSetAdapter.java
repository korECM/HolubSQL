...
public class ResultSetAdapter implements java.sql.ResultSet {
    ...
    public RowId getRowId(int columnIndex) throws SQLException {
        throw new SQLException("ResultSet.getRowId(int columnIndex) unsupported");
    }

    @Override
    public RowId getRowId(String columnLabel) throws SQLException {
        throw new SQLException("ResultSet.getRowId(String columnLabel) unsupported");
    }

    @Override
    public void updateRowId(int columnIndex, RowId x) throws SQLException {
        throw new SQLException("ResultSet.updateRowId(int columnIndex, RowId x) unsupported");
    }

    @Override
    public void updateRowId(String columnLabel, RowId x) throws SQLException {
        throw new SQLException("ResultSet.updateRowId(String columnLabel, RowId x) unsupported");
    }
    ...
    public void updateNString(int columnIndex, String nString) throws SQLException {
        throw new SQLException("ResultSet.updateNString(int columnIndex, String nString) unsupported");
    }

    @Override
    public void updateNString(String columnLabel, String nString) throws SQLException {
        throw new SQLException("ResultSet.updateNString(String columnLabel, String nString) unsupported");
    }

    @Override
    public void updateNClob(int columnIndex, NClob nClob) throws SQLException {
        throw new SQLException("ResultSet.updateNClob(int columnIndex, NClob nClob) unsupported");
    }

    @Override
    public void updateNClob(String columnLabel, NClob nClob) throws SQLException {
        throw new SQLException("ResultSet.updateNClob(String columnLabel, NClob nClob) unsupported");
    }

    @Override
    public NClob getNClob(int columnIndex) throws SQLException {
        throw new SQLException("ResultSet.getNClob(int columnIndex) unsupported");
    }

    @Override
    public NClob getNClob(String columnLabel) throws SQLException {
        throw new SQLException("ResultSet.getNClob(String columnLabel) unsupported");
    }

    @Override
    public SQLXML getSQLXML(int columnIndex) throws SQLException {
        throw new SQLException("ResultSet.getSQLXML(int columnIndex) unsupported");
    }

    @Override
    public SQLXML getSQLXML(String columnLabel) throws SQLException {
        throw new SQLException("ResultSet.getSQLXML(String columnLabel) unsupported");
    }

    @Override
    public void updateSQLXML(int columnIndex, SQLXML xmlObject) throws SQLException {
        throw new SQLException("ResultSet.updateSQLXML(int columnIndex, SQLXML xmlObject) unsupported");
    }

    @Override
    public void updateSQLXML(String columnLabel, SQLXML xmlObject) throws SQLException {
        throw new SQLException("ResultSet.updateSQLXML(String columnLabel, SQLXML xmlObject) unsupported");
    }

    @Override
    public String getNString(int columnIndex) throws SQLException {
        throw new SQLException("ResultSet.getNString(int columnIndex) unsupported");
    }

    @Override
    public String getNString(String columnLabel) throws SQLException {
        throw new SQLException("ResultSet.getNString(String columnLabel) unsupported");
    }

    @Override
    public Reader getNCharacterStream(int columnIndex) throws SQLException {
        throw new SQLException("ResultSet.getNCharacterStream(int columnIndex) unsupported");
    }

    @Override
    public Reader getNCharacterStream(String columnLabel) throws SQLException {
        throw new SQLException("ResultSet.getNCharacterStream(String columnLabel) unsupported");
    }

    @Override
    public void updateNCharacterStream(int columnIndex, Reader x, long length) throws SQLException {
        throw new SQLException("ResultSet.updateNCharacterStream(int columnIndex, Reader x, long length) unsupported");
    }

    @Override
    public void updateNCharacterStream(String columnLabel, Reader reader, long length) throws SQLException {
        throw new SQLException("ResultSet.updateNCharacterStream(String columnLabel, Reader reader, long length) " +
                "unsupported");
    }

    @Override
    public void updateAsciiStream(int columnIndex, InputStream x, long length) throws SQLException {
        throw new SQLException("ResultSet.updateAsciiStream(int columnIndex, InputStream x, long length) unsupported");
    }

    @Override
    public void updateBinaryStream(int columnIndex, InputStream x, long length) throws SQLException {
        throw new SQLException("ResultSet.updateBinaryStream(int columnIndex, InputStream x, long length) unsupported");
    }

    @Override
    public void updateCharacterStream(int columnIndex, Reader x, long length) throws SQLException {
        throw new SQLException("ResultSet.updateCharacterStream(int columnIndex, Reader x, long length) unsupported");
    }

    @Override
    public void updateAsciiStream(String columnLabel, InputStream x, long length) throws SQLException {
        throw new SQLException("ResultSet.updateAsciiStream(String columnLabel, InputStream x, long length) " +
                "unsupported");
    }

    @Override
    public void updateBinaryStream(String columnLabel, InputStream x, long length) throws SQLException {
        throw new SQLException("ResultSet.updateBinaryStream(String columnLabel, InputStream x, long length) " +
                "unsupported");
    }

    @Override
    public void updateCharacterStream(String columnLabel, Reader reader, long length) throws SQLException {
        throw new SQLException("ResultSet.updateCharacterStream(String columnLabel, Reader reader, long length) " +
                "unsupported");
    }

    @Override
    public void updateBlob(int columnIndex, InputStream inputStream, long length) throws SQLException {
        throw new SQLException("ResultSet.updateBlob(int columnIndex, InputStream inputStream, long length) " +
                "unsupported");
    }

    @Override
    public void updateBlob(String columnLabel, InputStream inputStream, long length) throws SQLException {
        throw new SQLException("ResultSet.updateBlob(String columnLabel, InputStream inputStream, long length) " +
                "unsupported");
    }

    @Override
    public void updateClob(int columnIndex, Reader reader, long length) throws SQLException {
        throw new SQLException("ResultSet.updateClob(int columnIndex, Reader reader, long length) unsupported");
    }

    @Override
    public void updateClob(String columnLabel, Reader reader, long length) throws SQLException {
        throw new SQLException("ResultSet.updateClob(String columnLabel, Reader reader, long length) unsupported");
    }

    @Override
    public void updateNClob(int columnIndex, Reader reader, long length) throws SQLException {
        throw new SQLException("ResultSet.updateNClob(int columnIndex, Reader reader, long length) unsupported");
    }

    @Override
    public void updateNClob(String columnLabel, Reader reader, long length) throws SQLException {
        throw new SQLException("ResultSet.updateNClob(String columnLabel, Reader reader, long length) unsupported");
    }

    @Override
    public void updateNCharacterStream(int columnIndex, Reader x) throws SQLException {
        throw new SQLException("ResultSet.updateNCharacterStream(int columnIndex, Reader x) unsupported");
    }

    @Override
    public void updateNCharacterStream(String columnLabel, Reader reader) throws SQLException {
        throw new SQLException("ResultSet.updateNCharacterStream(String columnLabel, Reader reader) unsupported");
    }

    @Override
    public void updateAsciiStream(int columnIndex, InputStream x) throws SQLException {
        throw new SQLException("ResultSet.updateAsciiStream(int columnIndex, InputStream x) unsupported");
    }

    @Override
    public void updateBinaryStream(int columnIndex, InputStream x) throws SQLException {
        throw new SQLException("ResultSet.updateBinaryStream(int columnIndex, InputStream x) unsupported");
    }

    @Override
    public void updateCharacterStream(int columnIndex, Reader x) throws SQLException {
        throw new SQLException("ResultSet.updateCharacterStream(int columnIndex, Reader x) unsupported");
    }

    @Override
    public void updateAsciiStream(String columnLabel, InputStream x) throws SQLException {
        throw new SQLException("ResultSet.updateAsciiStream(String columnLabel, InputStream x) unsupported");
    }

    @Override
    public void updateBinaryStream(String columnLabel, InputStream x) throws SQLException {
        throw new SQLException("ResultSet.updateBinaryStream(String columnLabel, InputStream x) unsupported");
    }

    @Override
    public void updateCharacterStream(String columnLabel, Reader reader) throws SQLException {
        throw new SQLException("ResultSet.updateCharacterStream(String columnLabel, Reader reader) unsupported");
    }

    @Override
    public void updateBlob(int columnIndex, InputStream inputStream) throws SQLException {
        throw new SQLException("ResultSet.updateBlob(int columnIndex, InputStream inputStream) unsupported");
    }

    @Override
    public void updateBlob(String columnLabel, InputStream inputStream) throws SQLException {
        throw new SQLException("ResultSet.updateBlob(String columnLabel, InputStream inputStream) unsupported");
    }

    @Override
    public void updateClob(int columnIndex, Reader reader) throws SQLException {
        throw new SQLException("ResultSet.updateClob(int columnIndex, Reader reader) unsupported");
    }

    @Override
    public void updateClob(String columnLabel, Reader reader) throws SQLException {
        throw new SQLException("ResultSet.updateClob(String columnLabel, Reader reader) unsupported");
    }

    @Override
    public void updateNClob(int columnIndex, Reader reader) throws SQLException {
        throw new SQLException("ResultSet.updateNClob(int columnIndex, Reader reader) unsupported");
    }

    @Override
    public void updateNClob(String columnLabel, Reader reader) throws SQLException {
        throw new SQLException("ResultSet.updateNClob(String columnLabel, Reader reader) unsupported");
    }

    @Override
    public <T> T getObject(int columnIndex, Class<T> type) throws SQLException {
        throw new SQLException("ResultSet.getObject(int columnIndex, Class<T> type) unsupported");
    }

    @Override
    public <T> T getObject(String columnLabel, Class<T> type) throws SQLException {
        throw new SQLException("ResultSet.getObject(String columnLabel, Class<T> type) unsupported");
    }
