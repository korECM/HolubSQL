...
public class StatementAdapter implements java.sql.Statement {
    ...
    public void setPoolable(boolean poolable) throws SQLException {
        throw new SQLException("Statement.setPoolable(boolean poolable) not supported");
    }
    ...
    public <T> T unwrap(Class<T> iface) throws SQLException {
        throw new SQLException("Statement.unwrap(Class<T> iface) not supported");
    }

    @Override
    public boolean isWrapperFor(Class<?> iface) throws SQLException {
        throw new SQLException("Statement.isWrapperFor(Class<?> iface) not supported");
    }
}
